...
AutoNeg is an AI model architecture designed to automatically generate negative prompts. Its purpose is to fine-tune XTuner, based on a large dataset of prompts from Stable Diffusion, to train an intelligent assistant capable of automatically completing negative prompts. This project is built on the InternLM 7B model. https://github.com/InternLM/InternLM
